...
ipgui::add_param -name "DEV_CONFIG" -component $cc
set p [ipgui:get_guiparamspec -name "DEV_CONFIG" -component $cc]
set_property -dict [list \
  "widget" "comboBox" \
...
set p [ipgui:get_guiparamspec -name "ADC_READ_MODE" -component $cc]
ipgui::add_param -name "ADC_READ_MODE" -component $cc
  "widget" "comboBox" \
