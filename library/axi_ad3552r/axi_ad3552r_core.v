...
module axi_ad3552r_core #(
  ...
  wire     [24:0]   dac_data_control;
  wire     [2:0]    dac_control;

  // defaults

  assign dac_source_sel  = {dac_source_sel_1 , dac_source_sel_0};
  assign dac_data        = (dac_source_sel == 8'h33 ) ? {16'b0, dac_data_channel_1[7:0],dac_data_channel_0[7:0]} : {dac_data_channel_1  ,dac_data_channel_0};
  assign dac_valid       = dac_valid_channel_0 | dac_valid_channel_1;

  assign control_data    = dac_data_control[15:0];
  assign address         = dac_data_control[23:16];
  assign control_valid   = dac_data_control[24];
...
// DAC CHANNEL 1
  ...
  axi_ad3552r_channel #(
    ...
    .control_data(control_data[15:8]),
    .dac_data_ready(dac_data_ready),
